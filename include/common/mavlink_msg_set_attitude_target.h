...
typedef struct __mavlink_set_attitude_target_t {
 ...
 float body_pitch_rate; /*< [rad/s] Body roll rate in radians per second*/
 float body_yaw_rate; /*< [rad/s] Body roll rate in radians per second*/
 ...
 * @param body_pitch_rate [rad/s] Body roll rate in radians per second
 * @param body_yaw_rate [rad/s] Body roll rate in radians per second
