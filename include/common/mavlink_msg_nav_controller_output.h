...
typedef struct __mavlink_nav_controller_output_t {
 ...
 int16_t target_bearing; /*< [deg] Bearing to current MISSION/target in degrees*/
 uint16_t wp_dist; /*< [m] Distance to active MISSION in meters*/
 ...
 * @param target_bearing [deg] Bearing to current MISSION/target in degrees
 * @param wp_dist [m] Distance to active MISSION in meters
 ...
 *
 * @return [deg] Bearing to current MISSION/target in degrees
 */
 ...
 *
 * @return [m] Distance to active MISSION in meters
 */
