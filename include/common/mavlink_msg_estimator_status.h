...
typedef struct __mavlink_estimator_status_t {
 ...
 float tas_ratio; /*< [Hz] True airspeed innovation test ratio*/
 ...
 * @param tas_ratio [Hz] True airspeed innovation test ratio
 ...
 *
 * @return [Hz] True airspeed innovation test ratio
 */
