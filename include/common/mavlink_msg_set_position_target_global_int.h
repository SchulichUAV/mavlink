...
typedef struct __mavlink_set_position_target_global_int_t {
 ...
 int32_t lat_int; /*< [degE7] X Position in WGS84 frame in 1e7 * meters*/
 int32_t lon_int; /*< [degE7] Y Position in WGS84 frame in 1e7 * meters*/
 ...
 * @param lat_int [degE7] X Position in WGS84 frame in 1e7 * meters
 * @param lon_int [degE7] Y Position in WGS84 frame in 1e7 * meters
 ...
 *
 * @return [degE7] X Position in WGS84 frame in 1e7 * meters
 */
 ...
 *
 * @return [degE7] Y Position in WGS84 frame in 1e7 * meters
 */
